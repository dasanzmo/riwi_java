...
public class AvionModel implements CRUD {
    ...
    public Object insert(Object object) {
        ...
        try{
            ...
            objPrepare.close();
            JOptionPane.showMessageDialog(null, "Plane " + objAvion.getModelo() + " was created successfully");
        }
        catch (Exception e){
    ...
    public boolean update(Object object) {
        ...
        try {
            ...
            if (rowAffected > 0) {
                isUpdated = true;
                JOptionPane.showMessageDialog(null, "Plane " + objAvion.getModelo() + " was updated successfully");
            }
        } catch (Exception e) {
    ...
    public boolean delete(Object object) {
        ...
        try {
            ...
            if (totalAffectedRows > 0) {
                isDeleted = true;
                JOptionPane.showMessageDialog(null, "Plane" + objAvion.getModelo() + " was deleted successfully.");
            }
